...
CREATE INDEX idx_pickup_requests_collector_id ON pickup_requests(collector_id);
CREATE INDEX idx_pickup_requests_state ON pickup_requests(current_state);
CREATE INDEX idx_ewaste_items_category_id ON ewaste_items(category_id);
CREATE INDEX idx_notifications_user_id ON notifications(user_id);
CREATE INDEX idx_processing_records_pickup_id ON processing_records(pickup_id);